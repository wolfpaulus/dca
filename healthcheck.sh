...
# The CMD ["python3.12",  "-m",  "streamlit", "run" "--server.port", "8000", "src/app.py"] 
...
# I.e. docker run <container-id> /dca/healthcheck.sh
...
(python3.12 -m streamlit run --server.port 8000 src/app.py) &
spid=$!
sleep 5
